...
function showMovies(movies) {
    ...
    movies.forEach((movie) => {
        ...
        movieEl.innerHTML = `<a href="http://reviewed-by-you/templates/movie.html?${id}" class="movieLink" style="display: block;" ><img src="${IMG_PATH + poster_path}" alt="${title}" /><div class="movie-info"><h3>${title}</h3><span class="${getClassByRate(vote_average)}">${vote_average}</span></div><div class="overview"><h3>Overview</h3><p>${overview}</p></div></a>`
